		...
		onload : function(e) {
			...
			setTimeout(function() {
				...
				if (responseWSQMT.success == true) {
					...
					$.listViewModelConveyorQuotation.sections[0].updateItemAt(parseInt(itemIndexModelTemp), row, {
						animated : true
					});
...
if (parseInt(idProfileUserLogin) == 4) {
	...
	// Asignamos un valor
	idClientQuo = Alloy.Globals.ID_CLIENT_QUOTATION;
	//args.quotation.client.user.business.id;
...
$.addQuotationFour.addEventListener('focus', function(e) {
